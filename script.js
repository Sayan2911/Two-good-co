...
var playbt = document.querySelector("#video-container")
playbt.addEventListener("click",function(){
   document.getElementById("chng-vid").style.opacity=0
   document.getElementById("chng-vid1").style.opacity=1
   document.getElementById("play").style.opacity=0
    playbtn=document.querySelector("#play1")
 })
